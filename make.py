...
def main():
    ...
    if sys.platform.startswith('linux'): download_file(
        "https://github.com/wpilibsuite/raspbian-toolchain/releases/download/v1.3.0/Raspbian9-Linux-Toolchain-6.3.0.tar.gz",
        "build")
    elif sys.platform.startswith('msys'): download_file(
            "https://github.com/wpilibsuite/raspbian-toolchain/releases/download/v1.3.0/Raspbian9-Windows-Toolchain-6.3.0.zip", "build")
    elif sys.platform.startswith('darwin'): download_file(
            "https://github.com/wpilibsuite/raspbian-toolchain/releases/download/v1.3.0/Raspbian9-Max-Toolchain-6.3.0.tar.gz", "build")
